...
DASS_Stress ~ PMSScoreNew
DASS_Anxiety ~ PMSScoreNew
DASS_Depression ~ PMSScoreNew
DASS_Total ~ PMSScoreNew

DASS_Stress ~ PMSScoreNew * TestMoment
DASS_Anxiety ~ PMSScoreNew * TestMoment
DASS_Depression ~ PMSScoreNew * TestMoment
DASS_Total ~ PMSScoreNew * TestMoment
...
ui<- fluidPage( # makes the User Interface
  sidebarPanel(
    selectInput("formula_choice", label="Choose a Formula:",
            choices= c('DASS_Stress ~ PMSScoreNew', 'DASS_Anxiety ~ PMSScoreNew', 'DASS_Depression ~ PMSScoreNew', 'DASS_Total ~ PMSScoreNew', 'DASS_Stress ~ PMSScoreNew * TestMoment', 'DASS_Anxiety ~ PMSScoreNew * TestMoment', 'DASS_Depression ~ PMSScoreNew * TestMoment', 'DASS_Total ~ PMSScoreNew * TestMoment'),

...
ui<- fluidPage( 
  sidebarPanel(
    selectInput("Stimulus", label="Choose a Stimulus:",
            choices= c('1710', '6313', '2057', '5600','9592','2165','9220','9300','1463','4658','7480','5030','4490','9320','2340','4531','9600
','7182','9921','1610','7211','4180'),
            selected='1710'), ),
...
server <- function (input, output){ 
  ...
  output$densityplot<- renderPlot({
    ...
    for (i in 1:length(dataBig$newid)){
      dataBig$val[i]<-mean(dataBig$Valence[dataBig$Stimulus[i]==input$Stimulus])}
    
    p1 <- ggplot(dataBig, aes(x=val ))+
      geom_density()
    p1

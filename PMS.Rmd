...
stim=c(9600)# here you fill in the number of the stimulus
#min
dataBig2$newid[dataBig2$Valence[dataBig2$Stimulus==stim]==min(dataBig2$Valence[dataBig2$Stimulus==stim])]
#max

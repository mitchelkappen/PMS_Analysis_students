...
server <- function (input, output){ 
 ...
 output$table <-renderTable({
  ...
  p_noPMS-PMS <- reactive ({emtable()[1,6]})
  p_noPMS-PMDD <- reactive ({emtable()[2,6]})
  p_PMS-PMDD <- reactive ({emtable()[3,6]})
  
  p_noPMS1-noPMS2 <- reactive ({emtable()[3,6]})
  p_PMS1-PMS2 <- reactive ({emtable()[7,6]})
  p_PMDD1-PMDD2 <- reactive ({emtable()[12,6]})

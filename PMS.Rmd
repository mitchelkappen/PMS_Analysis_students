...
*PMS: three groups originally: low and high PMS and what counts as ... on the questionnaire. 
These two last groups were taken together to form the 'no PMS' and 'PMS' groups

*TestMoment: there are two testmoments, 1 and 2. 1 stands for follicular phase, 2 for mid-luteal phase. 
these testmoments were counterbalanced across participants

!["Menstrual Cycle"](\Users\ASUSTeK\OneDrive\Documenten\GitHub\internship_sofie)

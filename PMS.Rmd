      ...
      if ((grepl("Stress", input$formula_choice))){
        ...
        dmean<-summarySE(data, measurevar="DASS_Stress", groupvars=c('PMSScoreNew', 'Moment'))
         p<- ggplot(data, aes(x=1, y=DASS_Stress, fill=PMSScoreNew))+
            ...
            geom_point(data = dmean, aes(x = 1, y = DASS_Stress, group = PMSScoreNew, fill = PMSScoreNew), position= position_dodge(0.2), shape = 21, size=4)+
          scale_x_discrete(labels=c('0.75'='noPMS', '1.25'='PMS'))+
...
-pas de violin plots toe mét automatische sterretjes. split violin plots en overlappende + lege tab voor 1x2 effect

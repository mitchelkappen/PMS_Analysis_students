...
![the etiology of PMS and depression have been linked together as well](figures/PMS_Symptoms.png){width=50%}
...
- Rating of 22 IAPS images while webcam records
  ...
  + e.g. during Moment 1 a puppy, during moment 2 a different puppy.
...
we looked at how participants answered. 
...
- sign diff for Arousal in PMS vs no PMS, also when controlled for TestMoment

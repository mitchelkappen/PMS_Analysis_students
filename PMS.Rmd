...
output$AD <- renderPrint({
  summary(Anova(as.formula(input$formula_choice), data=data))
})

#   d0.1 <- lmer(input$formula_choice,data=data)
#   d0.2 <- glmer(input$formula_choice,data=data, family = gaussian(link = "inverse"),glmerControl(optimizer= "bobyqa", optCtrl = list(maxfun = 100000)),nAGQ=nAGQ)
#   d0.3 <- glmer(input$formula_choice,data=data, family = gaussian(link = "log"),glmerControl(optimizer= "bobyqa", optCtrl = list(maxfun = 100000)),nAGQ=nAGQ)
#   
#   d0.4 <- glmer(input$formula_choice,data=data, family = Gamma(link = "identity"),glmerControl(optimizer= "bobyqa", optCtrl = list(maxfun = 100000)),nAGQ=nAGQ)
#   d0.5 <- glmer(input$formula_choice,data=data, family = Gamma(link = "inverse"),glmerControl(optimizer= "bobyqa", optCtrl = list(maxfun = 100000)),nAGQ=nAGQ)
#   d0.6 <- glmer(input$formula_choice,data=data, family = Gamma(link = "log"),glmerControl(optimizer= "bobyqa", optCtrl = list(maxfun = 100000)),nAGQ=nAGQ)
#   
#   d0.7 <- glmer(input$formula_choice,data=data, family = inverse.gaussian(link = "identity"),glmerControl(optimizer= "bobyqa", optCtrl = list(maxfun = 100000)),nAGQ=nAGQ)
#   d0.8 <- glmer(input$formula_choice,data=data, family = inverse.gaussian(link = "inverse"),glmerControl(optimizer= "bobyqa", optCtrl = list(maxfun = 100000)),nAGQ=nAGQ)
#   d0.9 <- glmer(input$formula_choice,data=data, family = inverse.gaussian(link = "log"),glmerControl(optimizer= "bobyqa", optCtrl = list(maxfun = 100000)),nAGQ=nAGQ)
#   

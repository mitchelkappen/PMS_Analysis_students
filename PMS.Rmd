...
logic indexen per participant 

gematched tussen testmomenten, A-B of B-A je wilt weten moment 1 of 2, kolom is er al 

1 datapunt per participant per testmoment per variabele (valence/arousal)

index valence, participantnr=.., testmoment=..

mean(dataBig$Valence)

als ik gemm wil v participant nr zoveel, gemm valence op alle stimuli voor testmoment 1
en dan loopen door alle participanten nr [i]
subloop voor alle testmomenten : loop in loop 2 regels code 

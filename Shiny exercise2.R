...
#shinyapps.io free website that allows you to run your app on a distant server, then pair with shinyapps account

#go to https://vimeo.com/rstudioinc/review/131218530/212d8a5a7a/ at 30:00 to see how to launch the app on a server
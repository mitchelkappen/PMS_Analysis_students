...
# THIS SCRIPT IS IDENTICAL TO stateAnalysis.R, BUT PARTICIPANTS WITH 'COPPER COIL' CONTRACEPTION ARE HERE EXCLUDED 
...
plot <- stateplot(data, emm0.2,'PSS', 'PSS') +
  # Follicular
  geom_segment(aes(x =.9, y = max_y, xend = 1, yend = max_y), size= 1)+ # line bottom first
  annotate('text', x=.95, y=max_y + max_y/100, label='*', size=7)+ # star
...
ggsave(plot, file=paste0(plotPrefix, "noCopperCoil_PSS.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px") # save plot
plot
...
ggsave(plot, file=paste0(plotPrefix, "noCopperCoil_PTQ.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px")
plot
...
plot <- stateplot(data, emm0.2, 'BSRI', 'BSRI') +
  ...
  geom_segment(aes(x =1.9, y = max_y+max_y/15, xend = 2.1, yend = max_y+max_y/15), size= 1)+ # top line
  annotate('text', x=2, y=max_y+max_y/15+max_y/100, label='***', size=7) # star
ggsave(plot, file=paste0(plotPrefix,supDir,"noCopperCoil_BSRI.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px") # save plot
plot
...
ggsave(corr_PSS_PTQ_noPMS, file=paste0(plotPrefix,supDir,"noCopperCoil_corr_PSS_PTQ_noPMS.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px") # save plot
# PMS
...
ggsave(corr_PSS_PTQ_PMS, file=paste0(plotPrefix,supDir,"noCopperCoil_corr_PSS_PTQ_PMS.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px") # save plot
# PMDD
...
ggsave(corr_PSS_PTQ_PMDD, file=paste0(plotPrefix,supDir,"noCopperCoil_corr_PSS_PTQ_PMDD.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px") # save plot
...
ggsave(corr_delta_PSS_PTQ_noPMS, file=paste0(plotPrefix,supDir,"noCopperCoil_corr_delta_PSS_PTQ_noPMS.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px") # save plot
# PMS
...
ggsave(corr_delta_PSS_PTQ_PMS, file=paste0(plotPrefix,supDir,"noCopperCoil_corr_delta_PSS_PTQ_PMS.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px") # save plot
#PMDD
...
ggsave(corr_delta_PSS_PTQ_PMDD, file=paste0(plotPrefix,supDir,"noCopperCoil_corr_delta_PSS_PTQ_PMDD.jpeg"), width = 2500, height = 1500, dpi = 300, units = "px") # save plot

...
formulas = c('PSS ~ PMSScoreNew*TestMoment', '..', '..', '..')
...
-code met for loop voor vergelijken modellen
-hoe de markdown images doen (want je maakt de pirateplot en voegt er een stuk code aan toe dat de significantie aangeeft. )
